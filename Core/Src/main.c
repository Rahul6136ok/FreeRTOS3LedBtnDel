 ...
 * create 3 tasks that toggles 3 different LEDs of STM32f407 Disc
 * create a button task that polls for the button press of every 10 ms
 * if the button task detects button press , it should send notification
 * to LED toggling task
 * when LED toggling task recives the notificaton , it should delete itself
 */
